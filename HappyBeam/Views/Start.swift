...
struct Start: View {
    ...
    var body: some View {
        VStack(spacing: 10) {
            ...
            Text("Ticket Ball Collect", comment: "The name of the game.")
                .font(.system(size: 30, weight: .bold))
            Text("Gather the sports balls by precisely aiming your gestures at the objects.", comment: "This text explains the purpose of the game.")
